...
if PlayerGui:FindFirstChild("Syrianhub_UI") then
    PlayerGui["Syrianhub_UI"]:Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "SyrianHub TP_UI"
...
Title.RichText = true
Title.Text = "<font color=\"rgb(255,255,255)\"><b>Syrianhub</b> TP</font>"
...
Thanks.Text = "Thanks for using this script ^Ã¢â‚¬Â¢^"
...
Base2Button.MouseButton1Click:Connect(function() 
    ...
    Markers = {BuildMarker(Stations.Base2, "TP HERE")} 
end)
...
Services.ProximityPromptService.PromptButtonHoldEnded:Connect(function(prompt, player)
    ...
    if prompt.ActionText == DecodeString("Tubmn") or prompt.Name == DecodeString("Tubmn") then
        ...
        if humanoidRootPart and Config.SavedPosition and Config.ProximityPosition then
            -- Teleporta para posiÃƒÂ§ÃƒÂ£o salva
            humanoidRootPart.CFrame = Config.SavedPosition
            task.wait(0.1)
            
            -- Teleporta para posiÃƒÂ§ÃƒÂ£o de proximidade
